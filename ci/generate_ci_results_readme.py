...
d'analyse produits pour `main` et pour les Pull Requests.
...
Les résultats sont ensuite poussés ici dans un sous-dossier dédié (`main` ou `pr-<numero>`). \
Le message de commit référence le SHA qui a déclenché la génération.
